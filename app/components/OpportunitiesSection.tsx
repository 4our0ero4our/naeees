        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24">
          ...
          <div className="lg:col-span-5 relative">
            <div className="sticky top-32 flex flex-col items-start space-y-6">
               ...
               <Link 
                 href="/opportunities"
                 className="group flex items-center gap-3 text-lg font-bold border-b-2 border-black pb-1 hover:text-[#22C55E] hover:border-[#22C55E] transition-all"
               >
                 View All Opportunities <FaArrowRight className="group-hover:translate-x-2 transition-transform" />
               </Link>
            </div>
          </div>
