  ...
  const menuItems = [
    {
      ...
      submenu: [
        { label: "Lecture Notes", href: "/dashbaord/materials", icon: <BookIcon /> },
        { label: "Past Questions", href: "/dashbaord/materials", icon: <DocumentIcon /> },
        { label: "CGPA Tracker", href: "/dashbaord/cgpa", icon: <ChartIcon /> },
        { label: "Academic Discussions", href: "/dashbaord/forum", icon: <ChatIcon /> },
        { label: "Learning Resources", href: "/dashbaord/materials", icon: <LibraryIcon /> },
      ],
      columns: 2,
    },
    {
      ...
      submenu: [
        { label: "Upcoming Events", href: "/dashbaord/events", icon: <CalendarIcon /> },
        { label: "Workshops & Trainings", href: "/dashbaord/events", icon: <ToolIcon /> },
        { label: "Conferences", href: "/dashbaord/events", icon: <MicrophoneIcon /> },
        { label: "Event Calendar", href: "/dashbaord/events", icon: <CalendarIcon /> },
        { label: "Register for Events", href: "/dashbaord/events", icon: <PenIcon /> },
      ],
      columns: 2,
    },
    {
      ...
      submenu: [
        { label: "Internships", href: "/dashbaord/announcements", icon: <BriefcaseIcon /> },
        { label: "Scholarships", href: "/dashbaord/announcements", icon: <GraduationIcon /> },
        { label: "Competitions", href: "/dashbaord/announcements", icon: <TrophyIcon /> },
        { label: "Announcements", href: "/dashbaord/announcements", icon: <MegaphoneIcon /> },
        { label: "Weekly Highlights", href: "/dashbaord/announcements", icon: <StarIcon /> },
      ],
      columns: 2,
    },
    {
      ...
      submenu: [
        { label: "Discussion Forum", href: "/dashbaord/forum", icon: <ForumIcon /> },
        { label: "Peer Q&A", href: "/dashbaord/forum", icon: <QuestionIcon /> },
        { label: "Face of the Week", href: "/dashbaord/announcements", icon: <UserIcon /> },
        { label: "Student Spotlights", href: "/dashbaord/announcements", icon: <SpotlightIcon /> },
      ],
      columns: 2,
    },
    {
      ...
      submenu: [
        { label: "About the Association", href: "/about", icon: <InfoIcon /> },
        { label: "Executives", href: "/about/#executives", icon: <UsersIcon /> },
        { label: "Mission & Vision", href: "/about/#mission-vision", icon: <TargetIcon /> },
