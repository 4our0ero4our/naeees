      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        >
          ...
          <motion.div variants={fadeInUp} className="lg:col-span-2">
            ...
            <ul className="space-y-4 text-gray-400 font-medium">
              <motion.li whileHover={{ x: 5, color: "#ffffff" }} className="cursor-pointer">
                <Link href="/dashbaord/materials" className="hover:underline decoration-[#22C55E] underline-offset-4">Lecture Notes</Link>
              </motion.li>
              <motion.li whileHover={{ x: 5, color: "#ffffff" }} className="cursor-pointer">
                <Link href="/dashbaord/materials" className="hover:underline decoration-[#22C55E] underline-offset-4">Past Questions</Link>
              </motion.li>
              <motion.li whileHover={{ x: 5, color: "#ffffff" }} className="cursor-pointer">
                <Link href="/dashbaord/cgpa" className="hover:underline decoration-[#22C55E] underline-offset-4">CGPA Calculator</Link>
              </motion.li>
              <motion.li whileHover={{ x: 5, color: "#ffffff" }} className="cursor-pointer">
                <Link href="/dashbaord/materials" className="hover:underline decoration-[#22C55E] underline-offset-4">Software Library</Link>
              </motion.li>
            </ul>
          </motion.div>
          ...
          <motion.div variants={fadeInUp} className="lg:col-span-2">
            ...
            <ul className="space-y-4 text-gray-400 font-medium">
              <motion.li whileHover={{ x: 5, color: "#ffffff" }} className="cursor-pointer">
                <Link href="/dashbaord/events" className="hover:underline decoration-[#22C55E] underline-offset-4">Events</Link>
              </motion.li>
              <motion.li whileHover={{ x: 5, color: "#ffffff" }} className="cursor-pointer">
                <Link href="/dashbaord/forum" className="hover:underline decoration-[#22C55E] underline-offset-4">Forum</Link>
              </motion.li>
              <motion.li whileHover={{ x: 5, color: "#ffffff" }} className="cursor-pointer">
                <Link href="/about#executives" className="hover:underline decoration-[#22C55E] underline-offset-4">Exco Members</Link>
              </motion.li>
              <motion.li whileHover={{ x: 5, color: "#ffffff" }} className="cursor-pointer">
                <Link href="/dashbaord/announcements" className="hover:underline decoration-[#22C55E] underline-offset-4">News Feed</Link>
              </motion.li>
            </ul>
          </motion.div>
        ...
        >
          ...
          <div className="flex gap-8">
            <Link href="/about" className="hover:text-[#22C55E] transition-colors">Privacy Policy</Link>
            <Link href="/about" className="hover:text-[#22C55E] transition-colors">Terms of Service</Link>
          </div>
        </motion.div>
